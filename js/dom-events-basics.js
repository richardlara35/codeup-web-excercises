...
//     imageNode.setAttribute("src", "img/tenor-23.gif");
...
function victoryEvent() {
    document.getElementById('victory')
        .addEventListener('click', sweetVictory);
}

function sweetVictory(){
    document.getElementById('sus-group')
        .appendChild(spongeGif());
}

function spongeGif(){
    // let music = document.createElement('iframe')
    // music.setAttribute('src', 'https://open.spotify.com/embed/track/0zNdw7vzK7nVtMlNkjVRfb" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media');
    // music.setAttribute('class', 'col-12 col-sm-6 col-md-4 px-0')
    let spongebob = document.createElement('img');
    spongebob.setAttribute('src', 'img/giphy.gif');
    spongebob.setAttribute('class', 'col-12')
    return spongebob
}
